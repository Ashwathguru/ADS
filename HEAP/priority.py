#3. Build priority queue to handle real time tasks. Tasks can arrive at time. The attributes of tasks are task-id, priority, arrival 
#time, execution time and deadline. Compute waiting time, turnaround time for each job. Check whether jobs are completed within the 
#deadline specified.  It is treated that 10 is maximum priority and 1 is least priority.
...
q.heap_add([101,3,1,5,10])
q.heap_add([103,4,1,5,10])
q.heap_add([103,4,3,5,10])
q.descOrder()
print(q.data)
